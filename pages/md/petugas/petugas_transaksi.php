        ...
        <div class="col-lg-8 p-r-0 title-margin-right">
          <div class="page-header">
            <div class="page-title">
              ...
              <button type="button" class="btn btn-primary"        onclick="window.location.href='?m=petugas/petugas_transaksi_semua'"  title="Lihat Semua Data"><i class="fa fa-table" aria-hidden="true"></i> Data Transaksi Berobat</button>
            </div>
          </div>
        </div>
                          ...
                          <tr>
                            ...
                            <td class="color-primary">
                              <form class="" action="" method="post">
                                <button type="button"  class="btn btn-warning btn-sm"       onclick="window.location.href='/pulautemiang/pages/md/petugas/edit/edit_transaksi.php?id_transaksi=<?php echo $a['id_transaksi'] ?> '"  title="Bayar"><i class="fa fa-money" aria-hidden="true"></i> Bayarkan Obat</button>

        ...
        <div class="container-fluid">
          ...
          if(isset($_POST['submit'])){
            ...
            if($sql){
              ...
              // echo '<script>alert("Berhasil menyimpan data."); document.location="/pulautemiang/pages/md/cetak/print_no_antrian_poli.php?id_pasien='.$id_pasien.'";</script>';
              echo '<script>alert("Berhasil menyimpan data."); document.location="/pulautemiang/pages/md/cetak/print_no_antrian_poli.php?id_pasien='.$id_pasien.'";</script>';
          ...
          $query = mysqli_query($conn, "  SELECT tb_pasien.id_pasien,tb_pasien.nama,tb_rekam_medis.no_rm FROM tb_pasien inner join tb_rekam_medis on tb_pasien.id_pasien=tb_rekam_medis.id_pasien where tb_pasien.id_pasien= '$pasien'");
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="basic-elements">
                      <form action="pendaftaran.php?id_pasien=<?php echo $pasien ?>"  method="post">
                        <div class="row">
                          <div class="col-lg-12">
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="" name="no_jamkes"  onkeypress="return isNumberKey(event)">
                              </div>
                              <div class="form-group">
                                <label>Status</label>

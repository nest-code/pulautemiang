...
if(!isset($_SESSION['nama_akun'])){
  ...
  $query = mysqli_query($conn, " SELECT * FROM tb_rekam_medis inner join tb_pasien on tb_pasien.nik=tb_rekam_medis.nik where tb_rekam_medis.nik='$pasien'");
  ...
  if(isset($_POST['submit'])){
    ...
    "UPDATE tb_rekam_medis SET nik='$id_pasien',id_petugas='$nip',tgl_rekam='$tgl_rekam',rpt='$rpt',rpo='$rpo',riw_alergi_mkn='$riw_alergi_mkn',riw_alergi_obat='$riw_alergi_obat',riw_operasi='$riw_operasi',riw_ayah='$riw_ayah',riw_ibu='$riw_ibu',riw_penyakit='$penyakit',jamkes='$jamkes',no_jamkes='$no_jamkes' WHERE no_rm='$no_rm'")or die(mysqli_error($conn));
    if($sql){
              ...
              <div class="card">
                ...
                <div class="card-body">
                  <div class="basic-elements">
                    <form action="edit_kajian_awal.php?nik=<?php "$pasien"; ?>"  method="post">
                      <!-- <form action="edit_pendaftaran.php?id_pendaftaran=<?php echo "$id_pendaftaran"; ?>"  method="post"> -->
                      <div class="row">
                        <input class="form-control" type="hidden" value="<?php echo $data['nik'];?>" name="nik" >
                        <div class="col-lg-3">
                        ...
                        <div class="col-lg-3">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="hidden" value="<?php echo $data['nik'];?>" name="nik"  readonly >
                      ...
                      <div class="row">
                        <div class="col-lg-6">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="text" value="<?php echo $data['jamkes'];?>" name="jamkes" readonly>
                          </div>
                        </div>
                        ...
                        <div class="col-lg-6">
                          <div class="form-group">
                            ...
                            <input class="form-control" type="text" value="<?php echo $data['no_jamkes'];?>" name="no_jamkes" readonly >
                          </div>
                        </div>

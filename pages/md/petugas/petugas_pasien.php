        ...
        <div class="col-lg-8 p-r-0 title-margin-right">
          <div class="page-header">
            <div class="page-title">
              <h1> <b>Data Pasien</b> | Pasien  </h1>
              <button type="button" class="btn btn-primary"  onclick="window.location.href='?m=petugas/petugas_pasien_semua'"  title="Data Pasien"><i class="fa fa-table" aria-hidden="true"></i> Data Pasien</button>
            </div>
          </div>
        </div>
                  ...
                  <div class="table-responsive">
                    <table id="bootstrap-data-table-export" class="table table-striped ">
                      ...
                      <tbody>
                        ...
                        $query = mysqli_query($conn, "SELECT * from tb_pasien inner join tb_rekam_medis on tb_pasien.nik=tb_rekam_medis.nik order by tb_rekam_medis.no_rm desc limit 1 ");
                          ...
                          <tr>
                            ...
                            <td class="color-primary">
                              <form class="" action="" method="post">
                                ...
                                <!-- <button title="button title" class="action primary tocart" onclick=" window.open('/pulautemiang/pages/md/cetak/print_kartu_berobat.php?id_pasien=<?php echo $a['id_pasien'] ?> ', '_blank'); return false;">Google</button> -->

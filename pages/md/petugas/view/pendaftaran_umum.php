                              ...
                              <div class="form-group">
                                ...
                                while ($a = mysqli_fetch_array($query)) {
                                  ...
                                  <div class="form-group">
                                    ...
                                    <input class="form-control" type="text" value="  <?php echo $a['id_petugas'];?>"   name="id_petugas" readonly>
                                ...
                                <div class="form-group" align="center">
                                  ...
                                  <button type="button"    onclick="window.location.href='/pulautemiang/index.php?m=petugas/petugas_pasien'"  class="btn btn-danger">Batal</button>
                                </div>
                              </div>
                            </div>
                          </form>

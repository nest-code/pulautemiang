      ...
      <div class="nano">
        <div class="nano-content">
          ...
          <ul>
            ...
            <li  class="sidebar-sub-toggle" ><a href="/pulautemiang/index.php?m=petugas/petugas_antrian_beranda">         <i class="ti-layers-alt"></i> Antrian Pasien <span class="badge badge-primary"></span> </span></a></li>
            ...
            <li  class="sidebar-sub-toggle" ><a href="/pulautemiang/index.php?m=petugas/petugas_pasien">         <i class="ti-user"></i> Data Pasien <span class="badge badge-primary"></span> </span></a></li>
          ...
          <div class="row">
            <div class="col-lg-8 p-r-0 title-margin-right">
              <div class="page-header">
                <div class="page-title">
                  ...
                  <button type="button"  class="btn btn-info " onclick="window.location.href='/pulautemiang/pages/md/cetak/print_transaksi.php?id_transaksi=<?php echo$data['id_resep_obat'] ?> '"  title="Lihat"><i class="fa fa-print" aria-hidden="true"></i></button>
                </div>
              </div>
            </div>
            <div class="col-lg-4 p-l-0 title-margin-left">
              <div class="page-header">
                <div class="page-title">
                  <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="/pulautemiang/index.php?m=petugas/petugas_transaksi">Data Pembayaran</a></li>
                    <li class="breadcrumb-item active">Transaksi Berobat</li>
                  </ol>
                </div>
              </div>
            </div>

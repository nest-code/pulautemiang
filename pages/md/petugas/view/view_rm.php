          ...
          <div class="col-lg-8 p-r-0 title-margin-right">
            <div class="page-header">
              <div class="page-title">
                ...
                <button type="button"  class="btn btn-default btn-sm"         onclick="window.location.href='/pulautemiang/pages/md/petugas/edit/edit_rm?id_pasien=<?php echo   $id_pasien ?> '"  title="Ubah"><i class="fa fa-edit" title="Ubah Rekam Medis Pasien"></i>Ubah Rekam Medis</button>
                <button type="button"  class="btn btn-warning btn-sm"         onclick="window.location.href='/pulautemiang/pages/md/dokter/edit/edit_detail_rm.php?no_rm=<?php echo $data['no_rm'] ?> '"  title="Periksa Pasien"><i class="fa fa-medkit"></i> Tambah Riwayat Rekam Medis</button>
              </div>
            </div>
          </div>
          <!-- /# column -->

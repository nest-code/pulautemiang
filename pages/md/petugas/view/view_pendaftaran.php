      ...
      <div class="main">
        <div class="container-fluid">
          ...
          if(isset($_POST['submit'])){
            ...
            $sql = mysqli_query($conn, "insert into tb_pendaftaran values('','$tanggal','$status','$id_jenis_poli','$nik','$id_petugas','$no_antrian')") or die(mysqli_error($conn));

            if($sql){
              $checkNumber = mysqli_query($conn, "insert into tb_antrian_increment values('','$id_jenis_poli')") or die(mysqli_error($conn));

                  echo '<script>alert("Berhasil menyimpan data."); document.location="/pulautemiang/pages/md/cetak/print_no_antrian.php?nik='.$nik.'";</script>';
            ...
            $conn = mysqli_connect($host, $username, $pass, $db);
            $nik= $_GET['nik'];
            $query = mysqli_query($conn, "  SELECT nik,nama FROM tb_pasien where nik ='$nik'");
                  ...
                  <div class="card">
                    ...
                    <div class="card-body">
                      <div class="basic-elements">
                        <form action="view_pendaftaran.php?nik=<?php echo $nik ?>"  method="post">
                          <div class="row">
                            <div class="col-lg-12">

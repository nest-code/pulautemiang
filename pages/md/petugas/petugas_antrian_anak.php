    ...
    <div class="row">
      <div class="col-lg-8 p-r-0 title-margin-right">
        <div class="page-header">
          ...
          <h1> <b>Poli Anak</b> | Antrian Poli Anak </h1>
              ...
              <div class="table-responsive">
                <table id="bootstrap-data-table-export" class="table table-striped ">
                  ...
                  <tbody>
                    ...
                    $query = mysqli_query($conn, "  SELECT * FROM tb_pendaftaran where status in ('Menunggu','Proses') and id_jenis_poli='7' and tanggal like '%$tanggal%' order by tanggal asc ");

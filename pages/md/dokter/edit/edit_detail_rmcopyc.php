  ...
  <body>
    <div class="sidebar sidebar-hide-to-small sidebar-shrink sidebar-gestures">
      ...
      if(isset($_POST['submit'])){
        ...
        // $cek = "insert into tb_detail_rm values('$id_detail_rekam_medis','$no_rm','$tgl_kunjungan','$subjektif','$objektif','$assement','$plant')";
        // var_dump($cek);
        // die();
        ...
        $sql =mysqli_query($conn,"insert into tb_detail_rm values('$id_detail_rekam_medis','$no_rm','$tgl_kunjungan','$subjektif','$objektif','$assement','$plant')") ;
        if($sql){
          echo
          '<script>
                          ...
                          <div class="row">
                            <div class="col-lg-6">
                              <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="<?php echo  date('Y-m-d')?>" readonly >
                              </div>
                            </div>
                          ...
                          <div class="row">
                            <div class="col-lg-3">
                              <div class="form-group">
                                ...
                                <input class="form-control" type="hidden" value="<?php echo date('dmYHis'); ?>" name="" readonly >
                              </div>
                            </div>

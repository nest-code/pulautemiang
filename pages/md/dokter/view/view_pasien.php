    ...
    <div class="content-wrap">
        <div class="main">
            <div class="container-fluid">
                ...
                $id_pasien= $_GET['nik'];
                $query = mysqli_query($conn, "  select * from tb_pasien where nik=  '$id_pasien'");
                            ...
                            <div class="basic-elements">
                              <form>
                                <div class="row">
                                  ...
                                  <div class="col-lg-6">
                                    <input class="form-control" type="hidden" name="nik" placeholder="nik" value="<?php echo $data['nik']; ?>"  readonly=""  >
                                    ...
                                    <div class="form-group">
                                      ...
                                      <select class="form-control" name="gol_darah" readonly>
                                        <option>-Pilih-</option>

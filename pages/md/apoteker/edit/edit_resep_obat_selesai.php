...
if(!isset($_SESSION['nama_akun'])){
  ...
  $query = mysqli_query($conn, " SELECT * FROM tb_resep_obat inner join tb_pasien on tb_resep_obat.id_pasien=tb_pasien.id_pasien where tb_resep_obat.id_resep_obat='$id_resep_obat'");
  ...
  if(isset($_POST['submit'])){
    ...
    if($sql1){
      ...
      '<script>
      alert("Berhasil");
      document.location="/pulautemiang/index.php?m=apoteker/apoteker_ambil_obat";
      </script>';
    }else{
        ...
        <div class="nano-content">
          <div class="logo"><a href="index.html">
            ...
            <ul>
              ...
              <li><a href="/pulautemiang/index.php?m=apoteker/apoteker_ambil_obat">         <i class="ti-hand-open"></i>Ambil Obat <span class="badge badge-primary"></span> </span></a></li>
              <li><a href="/pulautemiang/index.php?m=apoteker/apoteker_transaksi">         <i class="ti-money"></i>Pembayaran <span class="badge badge-primary"></span> </span></a></li>
            </li>
          </ul>
        </div>
      </div>
                ...
                <div class="card">
                  ...
                  <div class="card-body">
                    <div class="basic-elements">
                      <form action="edit_resep_obat_selesai.php?id_resep_obat=<?php echo "$id_resep_obat"; ?>"  method="post">
                          ...
                          <div class="col-lg-12">
                            <div class="form-group">
                              ...
                              <div class="form-group">
                                ...
                                <input class="form-control" type="text" value="<?php echo $data['nama'];?>" name="id_pasien" readonly>
                              </div>
                            ...
                            <div class="row">
                              ...
                              <!-- <div class="col-lg-2"> -->
                                <!-- <div class="form-group"> -->
                                  <!-- <label>Status</label> -->
                                  <input class="form-control" type="hidden" name="status_bayar" value="Belum Bayar" readonly>
                                <!-- </div> -->
                              <!-- </div> -->

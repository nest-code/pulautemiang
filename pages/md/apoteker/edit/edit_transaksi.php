        ...
        <div class="main">
          <div class="container-fluid">
            <div class="row">
              <div class="col-lg-8 p-r-0 title-margin-right">
                <div class="page-header">
                  <div class="page-title">
                    <h1> <b>Transasksi Berobat </b> | Serahkan Obat  </h1>
                  </div>
                </div>
              </div>
              <!-- /# column -->
              <div class="col-lg-4 p-l-0 title-margin-left">
                <div class="page-header">
                  <div class="page-title">
                    <ol class="breadcrumb">
                      <li class="breadcrumb-item"><a href="/pulautemiang/?m=apoteker/apoteker_transaksi">Data Transaksi</a></li>
                      <li class="breadcrumb-item active">Ubah Status Transaksi</li>
                    </ol>
                  </div>
                </div>
              </div>
            ...
            if(isset($_POST['submit'])){
              ...
              $sql = mysqli_query($conn, "UPDATE tb_transaksi_berobat set status_transaksi='Selesai' where id_transaksi='$transaksii'") or die(mysqli_error($conn));
              if($sql){
                echo
                '<script>
                alert("Berhasil Membayarkan Obat");
                document.location="/pulautemiang/index.php?m=apoteker/apoteker_transaksi";
                </script>';
              }else{
            ...
            $query = mysqli_query($conn, "  SELECT * FROM tb_transaksi_berobat inner join tb_resep_obat on tb_transaksi_berobat.id_resep_obat=tb_resep_obat.id_resep_obat inner join tb_pasien on tb_resep_obat.nik=tb_pasien.nik where tb_transaksi_berobat.id_transaksi= '$transaksi'");
                            ...
                            <div class="col-lg-12">
                              <div class="form-group">
                                ...
                                <div class="form-group">
                                  ...
                                  <input class="form-control"  type="text" name="status_transaksi"  value="<?php echo $data['status_transaksi']; ?>" readonly>
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group">
                                  <label>NIK</label>
                                  <input class="form-control" type="text"  value="<?php echo $data['nik']; ?>" readonly >
                                </div>
                                <div class="form-group">
                                  <label>No RM</label>
                                  <input class="form-control" type="text"  value="<?php echo $data['no_rm']; ?>" readonly >
                                </div>
                                <div class="form-group">
                                ...
                                <div class="form-group" align="center">
                                  <button type="submit"name="submit" value="submit" class="btn btn-primary">Selesai</button>

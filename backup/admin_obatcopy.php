                        ...
                        <tr>
                          ...
                          <td class="color-primary">
                            ...
                            <form class="" action="#" method="post">
                              ...
                              <button type="button" class="btn btn-info btn-sm" data-toggle="modal" data-target="#myModalihatss<?php echo $nip;?>" title="Lihat"><i class="ti-eye"></i></button>
                              ...
                              <button type="button"  class="btn btn-danger btn-sm" onclick="window.location.href='../backend/delete/delete_obat.php?id_obat=<?php echo $a['id_obat'] ?> '" title="Hapus"><i class="fa fa-eraser"></i></button>
                            </td>
                          </tr>

        ...
        <div class="col-lg-8 p-r-0 title-margin-right">
          <div class="page-header">
            <div class="page-title">
              <h1> <b>Poli IGD</b> |Antrian Poli IGD  </h1>
                  ...
                  <div class="table-responsive">
                    <table id="bootstrap-data-table-export" class="table table-striped ">
                      ...
                      <tbody>
                        ...
                        $tanggal=date('Y-m-d');
                        // $query = mysqli_query($conn, "  SELECT * FROM tb_pendaftaran inner join tb_pasien on tb_pendaftaran.id_pasien=tb_pasien.id_pasien where tb_pendaftaran.status in ('Menunggu','Proses') and tb_pendaftaran.id_jenis_poli='4' and tb_pendaftaran.tanggal like '%$tanggal%' order by tb_pendaftaran.tanggal asc ");
                        $query = mysqli_query($conn, "  SELECT * FROM tb_pendaftaran inner join tb_pasien on tb_pendaftaran.id_pasien=tb_pasien.id_pasien inner join tb_rekam_medis on tb_rekam_medis.id_pasien=tb_pasien.id_pasien where tb_pendaftaran.status in ('Menunggu','Proses') and tb_pendaftaran.id_jenis_poli='4' and tb_pendaftaran.tanggal like '%$tanggal%' order by tb_pendaftaran.tanggal asc ");
                          ...
                          <tr>
                            ...
                            <td class="color-primary">
                              ...
                              <form class="" action="" method="post">
                                ...
                                <button type="button"  class="btn btn-info btn-sm"          onclick="window.location.href='/pulautemiang/pages/md/petugas/view/view_pasien.php?id_pasien=<?php echo $a['id_pasien'] ?> '"  title="Lihat"><i class="ti-eye"></i></button>

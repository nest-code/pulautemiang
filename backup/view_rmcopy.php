            ...
            <div class="col-lg-8 p-r-0 title-margin-right">
              <div class="page-header">
                <div class="page-title">
                  ...
                  <button type="button"  class="btn btn-default btn-sm"         onclick="window.location.href='/pulautemiang/admin/pages/md/dokter/view/view_detail_rm.php?id_pasien=<?php echo $data['id_pasien'] ?> '"  title="Ubah"><i class="fa fa-edit" title="Edit"></i></button>
                  <button type="button"  class="btn btn-primary btn-sm"         onclick="window.location.href='/pulautemiang/admin/pages/md/dokter/edit/edit_detail_rm.php?no_rm=<?php echo $data['no_rm'] ?> '"  title="Periksa Pasien"><i class="fa fa-medkit"></i></button>
                                ...
                                <tr>
                                  ...
                                  <td class="color-primary">
                                    <form class="" action="" method="post">
                                      <button type="button"  class="btn btn-primary btn-sm"         onclick="window.location.href='/pulautemiang/admin/pages/md/dokter/view/view_detail_rm_beranda.php?id_detail_rekam_medis=<?php echo $a['id_detail_rekam_medis'] ?> '"  title="Periksa Pasien"><i class="fa fa-medkit"></i></button>
                                      <button type="button"  class="btn btn-success btn-sm"         onclick="window.location.href='/pulautemiang/admin/pages/md/admin/view/view_dokter.php?nip=<?php echo $a['nip'] ?> '"  title="Lihat"><i class="fa fa-eye" title="Lihat"></i></button>
                                      <button type="button"  class="btn btn-default btn-sm"         onclick="window.location.href='/pulautemiang/admin/pages/md/admin/view/view_dokter.php?nip=<?php echo $a['nip'] ?> '"  title="Ubah"><i class="fa fa-edit" title="Edit"></i></button>

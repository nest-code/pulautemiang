...
<div id="ModalBangunan" class="modal fade" role="dialog">
  <div class="modal-dialog" style="width:715px">
    ...
    <form action="#" method="post" enctype="multipart/form-data">
      <div class="modal-content">
        ...
        <div align="center" class="modal-header">
          ...
          <?php
          $ambilkode = "SELECT max(bpc_id) as no_id from tb_building_permit_certificate";
          ...
          while ($data = mysqli_fetch_array($hasil)) {
            ...
            ?>
            <input style="text-align:center;" type="hidden" name="bpc_id" value="<?php echo $new_reg; ?>" readonly>
            <?php
          }
          ?>
                ...
                <div class="table-responsive">
                  <table class="table">
                    <tr>
                      ...
                      <td>:</td>
                      <td><input type="text" maxlength="16" name="population_nik" id="nik" class="form-control"  placeholder="Nomor Identitas" required="true"  onkeypress="return isNumberKey(event)" oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')"></td>
                    </tr>

                    <tr>
                      <td width="150px">Nama Lengkap</td>
                      <td>:</td>
                      <td><input type="text" maxlength="30" name="population_name" value="" class="form-control" placeholder="isi nama lengkap anda" required="true"  onkeypress="return isAlphabetkey(event)"oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')"></td>
                    </tr>
                    ...
                    <tr>
                      ...
                      <td>:</td>
                      <td><input type="text" maxlength="20" name="population_place" value="" class="form-control" placeholder="isi alamat anda" required="true"></td>
                    </tr>

                    <tr>
                      <td width="150px">RT</td>
                      <td>:</td>
                      <td><input type="phone" maxlength="3"  name="population_rt" value="" class="form-control" placeholder="isi RT" required="true"  onkeypress="return isNumberKey(event)"oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')"></td>
                    </tr>
                    <tr>
                      <td width="150px">RW</td>
                      <td>:</td>
                      <td><input type="phone" maxlength="3" name="population_rw" value="" class="form-control" placeholder="isi RW" required="true"  onkeypress="return isNumberKey(event)"oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')"></td>
                    </tr>
                    <tr>
                      <td width="150px">Kelurahan</td>
                      <td>:</td>
                      <td><input type="text" maxlength="50" name="population_kelurahan" value="" class="form-control" placeholder="isi kelurahan" required="true"></td>
                    </tr>
                    <tr>
                      <td width="150px">Kecamatan</td>
                      <td>:</td>
                      <td><input type="text" maxlength="50" name="population_kecamatan" value="" class="form-control" placeholder="isi kecamatan" required="true"></td>
                    </tr>
                    <tr>
                      <td width="150px">Provinsi</td>
                      <td>:</td>
                      <td><input type="text" maxlength="50" name="population_provinsi" value="" class="form-control" placeholder="isi provinsi" required="true"></td>
                    </tr>

                    <tr>
                      <td width="150px">Pekerjaan</td>
                      <td>:</td>
                      <td><select name="population_work" class="form-control" >
          ...
          <div class="panel-body">
            <div class="table-responsive">
              <table class="table">
                ...
                <tr>
                  <td width="150px">Jenis Bangunan</td>
                  <td>:</td>
                  <td><select name="bpc_type" class="form-control" >
                    <option value="Mendirikan Bangunan" >Mendirikan Bangunan</option>
                    <option value="Mendirikan Pondokan" >Mendirikan Pondokan</option>
                  </select>
                </td>
              </tr>
              <tr>
                ...
                <td>:</td>
                <td><input type="text" maxlength="200" name="bpc_place" value="" class="form-control" placeholder="isi tempat" required="true"></td>
              </tr>
              <tr>
                <td width="150px">RT</td>
                <td>:</td>
                <td><input type="phone" maxlength="3" name="bpc_rt" value="" class="form-control" placeholder="isi RT" required="true"  onkeypress="return isNumberKey(event)"oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')"></td>
              </tr>
              <tr>
                <td width="150px">RW</td>
                <td>:</td>
                <td><input type="phone" maxlength="3" name="bpc_rw" value="" class="form-control" placeholder="isi RW" required="true"  onkeypress="return isNumberKey(event)"oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')"></td>
              </tr>
              <tr >
                <td colspan="3" align="center"><b>--- Keterangan Sekitar Bangunan ---</b></td>
              </tr>
              <tr>
                <td width="150px">Utara</td>
                <td>:</td>
                <td><textarea maxlength="50" name="bpc_north" value="" class="form-control" placeholder="isi keterangan sebelah selatan" required="true"  onkeypress="return isAlphabetkey(event)"oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')"></textarea></td>
              </tr>
              <tr>
                <td width="150px">Selatan</td>
                <td>:</td>
                <td>
                  <textarea type="text" maxlength="50" name="bpc_south" value="" class="form-control" placeholder="isi keterangan sebelah selatan" required="true"></textarea>
                </td>
              </tr>
              <tr>
                <td width="150px">Timur</td>
                <td>:</td>
                <td>
                  <textarea type="text" maxlength="50" name="bpc_east" value="" class="form-control" placeholder="isi keterangan sebelah barat" required="false"></textarea>
                </td>
              </tr>
              <tr>
                <td width="150px">Barat</td>
                <td>:</td>
                <td>
                  <textarea type="text" maxlength="50" name="bpc_west" value="" class="form-control" placeholder="isi keterangan sebelah barat" required="false"></textarea>
                </td>
              </tr>
              <tr>
                ...
                <td>:</td>
                <td>
                  <textarea type="text" maxlength="200" name="bpc_information" value="" class="form-control" placeholder="isi keterangan tambahan" required="false"></textarea>
                </td>
              </tr>
            </table>
          </div>
    ...
    <div align="center">
      <p>&nbsp;</p>
      <button type="submit" name="applicant_building" class="btn btn-primary"><i class="fa fa-send"></i> Kirim</button>
    </div>
  </div>
</form>
...
<!--END Modal SURAT BANGUNAN -->

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper">
  <section class="content-header" >
    <h1 text-align="center">Daftar Pengajuan Izin Mendirikan Bangunan</h1>
  </section>

  <section class="content">
    <button type="button" name="button" class="btn btn-primary" data-toggle="modal" data-target="#ModalBangunan"> Tambah Data</button>
          ...
          <table id="example1" class="table table-bordered table-hover">
            <thead>
              <tr class="table-primary">
                ...
                <th><span class="fa fa-home"> Jenis</th>
            ...
            <tbody>
              ...
              $query = mysqli_query($conn, "select * from tb_applicant join tb_population on tb_population.population_nik=tb_applicant.population_nik join tb_building_permit_certificate on tb_applicant.applicant_id=tb_building_permit_certificate.applicant_id where tb_applicant.status != 'Selesai' ORDER BY tb_applicant.status");
                  ...
                  <td>
                    ...
                    <form class="" action="#" method="post">
                      <div class="btn-group-horizontal btn-group-sm">
                        ...
                        <button type="submit" name="delete_building" class="btn btn-danger"><i class="fa fa-eraser"></i> Hapus</button>
                        ...
                        <div class="modal fade" id="myModal<?php echo $applicant_id;?>" role="dialog">
                          <div class="modal-dialog modal-lg">
                            ...
                            <div class="modal-content">
                              <div align="center" class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h4 class="modal-title">Data Mengajukan Surat Keterangan Izin Bangunan</h4>
                              </div>
                              <div class="modal-body">
                                <!-- body -->
                                <?php
                                ...
                                $lihat=mysqli_query($conn,"select * from tb_population join tb_applicant on tb_population.population_nik=tb_applicant.population_nik join tb_building_permit_certificate on tb_applicant.applicant_id=tb_building_permit_certificate.applicant_id where tb_applicant.applicant_id='$applicant_id'");

                                while ($out = mysqli_fetch_object($lihat)) {
                                  ?>
                                  <input type="hidden" name="bpc_id" value="<?php echo $bpc_id;?>">
                                  <input type="hidden" name="applicant_id" value="<?php echo $applicant_id;?>">

                                  <!--PELAPOR-->
                                  <div class="panel panel-default">
                                    <div class="panel-heading">
                                      <h4>Permohonan Surat Izin Bangunan</h4>
                                    </div>
                                    <div class="panel-body">
                                      <div class="table-responsive">
                                        <table class="table">
                                          ...
                                          <tr>
                                            <td  width="175px">Jenis Bangunan</td>
                                            <td>:</td>
                                            <td width="525px" id="text3"><?php echo "$out->bpc_type"?></td>
                                            <td width="25px">
                                          ...
                                          <tr>
                                            <td  width="175px">Tempat yang diajukan</td>
                                            <td>:</td>
                                            <td width="525px" id="text4"><?php echo "$out->bpc_place"?></td>
                                            <td width="25px">
                                          ...
                                          <tr>
                                            ...
                                            <td>:</td>
                                            <td width="525px" id="text4"><?php echo "$out->bpc_rt"?></td>
                                            <td width="25px">
                                              <button id="button4" type="button" class="btn btn-warning" onclick="copy('#text4')" href="#" data-toggle="popover4" data-content="Copied."><i class="fa fa-copy"></i></button>
                                            </td>
                                          </tr>
                                            ...
                                            <td  width="175px">RW</td>
                                            <td>:</td>
                                            <td width="525px" id="text5"><?php echo "$out->bpc_rw"?></td>
                                            <td width="25px">
                                            ...
                                            <tr>
                                              <td width="175px">Bagian Utara </td>
                                              <td>:</td>
                                              <td width="525px" id="text6"><?php echo "$out->bpc_north"?></td>
                                              <td width="25px">
                                            ...
                                            <tr>
                                              <td  width="175px">Bagian Selatan</td>
                                              <td>:</td>
                                              <td width="525px" id="text7"><?php echo "$out->bpc_south"?></td>
                                              <td width="25px">
                                                <button id="button7" type="button" class="btn btn-warning" onclick="copy('#text7')" href="#" data-toggle="popover7" data-content="Copied."><i class="fa fa-copy"></i></button>
                                              </td>
                                            </tr>

                                            <tr>
                                              <td  width="175px">Bagian Timur</td>
                                              <td>:</td>
                                              <td width="525px" id="text7"><?php echo "$out->bpc_east"?></td>
                                              <td width="25px">
                                                <button id="button7" type="button" class="btn btn-warning" onclick="copy('#text7')" href="#" data-toggle="popover7" data-content="Copied."><i class="fa fa-copy"></i></button>
                                              </td>
                                            </tr>
                                            ...
                                            <tr>
                                              <td  width="175px">Bagian Selatan</td>
                                              <td>:</td>
                                              <td width="525px" id="text7"><?php echo "$out->bpc_west"?></td>
                                              <td width="25px">
                                                <button id="button7" type="button" class="btn btn-warning" onclick="copy('#text7')" href="#" data-toggle="popover7" data-content="Copied."><i class="fa fa-copy"></i></button>
                                              </td>
                                            </tr>
                                        ...
                                        <div class="table-responsive">
                                          ...
                                          <table class="table">
                                            ...
                                            <tr>
                                              ...
                                              <td>:</td>
                                              <td width="525px" id="text9"><?php echo "$out->population_work" ?></td>
                                              <td width="25px">
                                                <button id="button9" type="button" class="btn btn-warning" onclick="copy('#text9')" href="#" data-toggle="popover9" data-content="Copied."><i class="fa fa-copy"></i></button>
                                              </td>
                                            </tr>

...
<!-- Modal SURAT PENUTUPAN JALAN -->
<div id="ModalJalan" class="modal fade" role="dialog">
		...
		<form action="#" method="post" enctype="multipart/form-data">
			<div class="modal-content">
				...
				<div align="center" class="modal-header">
					...
					<?php
					$ambilkode = "SELECT max(rcpc_id) as no_id from tb_road_clousure_permit_certificate";
					...
					while ($data = mysqli_fetch_array($hasil)) {
						...
						?>
						<input style="text-align:center;" type="hidden" name="rcpc_id" value="<?php echo $new_reg; ?>" readonly>
						<?php
					}
					?>
				...
				<div class="modal-body">
								...
								<div class="table-responsive">
									<table class="table">
										...
										<tr>
											...
											<td>:</td>
											<td><input type="text"  maxlength="50"  name="population_name" value="" class="form-control" placeholder="isi nama lengkap anda" required="true"  onkeypress="return isAlphabetkey(event)" oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')"></td>
										</tr>
										<tr>
                      ...
                      <td><input type="date"  value="<?php echo date('1990-m-d'); ?>" max="<?php echo date('Y-m-d'); ?>" name="population_birthday"  class="form-control" placeholder="isi tgl lahir anda" required="true"oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')"  onkeypress="return isAlphabetkey(event)"></td>
                          ...
                          <option value="">-Pilih-</option>
										...
										<tr>
											...
											<td>:</td>
											<td>
												<select name="population_status" class="form-control" required >
                          <option value="">-Pilih-</option>
					...
					<div class="container">
						<div class="panel panel-default" style="width:650px">
							<div class="panel-heading">
								<h4>KETERANGAN PENUTUPAN JALAN</h4>
							</div>
							<div class="panel-body">
								<div class="table-responsive">
									<table class="table">
										<tr>
											<td width="150px">Nama Aktivitas</td>
											<td>:</td>
											<td><input type="text"  maxlength="25"  name="rcpc_activity" value="" class="form-control" placeholder="isi nama aktivitas" required="true"></td>
										</tr>

										<tr>
											<td width="150px">Jenis Aktivitas</td>
											<td>:</td>
											<td><input type="text"  maxlength="25" name="rcpc_character" value="" class="form-control" placeholder="isi jenis aktivitas" required="true"></td>
										</tr>
										<tr>
											<td width="150px">Tanggal Mulai Penutupan</td>
											<td>:</td>
											<td>
												<input type="date" value="<?php echo $date; ?>" min="<?php echo $date;?>" onchange="setMax();" id='start_date' name="rcpc_time_start" class="form-control" onkeypress="return isAlphabetkey(event)" placeholder="isi tgl mulai penutupan" required="true"oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')" >
											</td>
										</tr>
										<tr>
											<td width="150px">Tannggal Selesai Penutupan</td>
											<td>:</td>
											<td>
												<input type="date" value="<?php echo $date; ?>" min="<?php echo $date;?>" name="rcpc_time_end" id='end_date' class="form-control" placeholder="isi tgl selesai penutupan" required="true" oninvalid="this.setCustomValidity('Data Tidak Boleh Kosong')" oninput="setCustomValidity('')" onkeypress="return isAlphabetkey(event)">
											</td>
										</tr>
										<tr>
											...
											<td>:</td>
											<td>
												<input type="text" maxlength="25" name="rcpc_place" value="" class="form-control" placeholder="isi tempat" required="false">
											</td>
										</tr>
										<tr>
											...
											<td>:</td>
											<td>
												<input type="text" maxlength="20" name="rcpc_information" value="" class="form-control" placeholder="isi tempat" required="false">
											</td>
										</tr>
									</table>
								</div>
					...
					<div align="center">
						<p>&nbsp;</p>
						<button type="submit" name="applicant_road_clousure" class="btn btn-primary"><i class="fa fa-send"></i> Kirim</button>
					</div>
				</div>
			</form>
...
<!--END Modal SURAT PENUTUPAN JALAN -->

<!-- Content Wrapper. Contains page content -->
<div class="content-wrapper">
  <section class="content-header" >
    <h1 text-align="center">Daftar Pengajuan Surat Izin Penutupan Jalan</h1>
  </section>
  <section class="content">
    <button type="button" name="button" class="btn btn-primary" data-toggle="modal" data-target="#ModalJalan"> Tambah Data</button>
        ...
        <div class="box-body table-responsive">
          <table id="example1" class="table table-bordered table-hover">
            ...
            <tbody>
              ...
              $query = mysqli_query($conn, "select * from tb_applicant join tb_population on tb_population.population_nik=tb_applicant.population_nik join tb_road_clousure_permit_certificate  on tb_applicant.applicant_id=tb_road_clousure_permit_certificate.applicant_id where tb_applicant.status != 'Selesai' ORDER BY tb_applicant.status");
                    ...
                    <form class="" action="#" method="post">
                      <div class="btn-group-horizontal btn-group-sm">
                        <button type="button" class="btn btn-info btn-lg" data-toggle="modal" data-target="#myModal<?php echo $applicant_id;?>"><i class="fa fa-user"></i> Lihat</button>
												  <button type="submit" name="delete_road_clousure" class="btn btn-danger"><i class="fa fa-eraser"></i> Hapus</button>
                        ...
                        <div class="modal fade" id="myModal<?php echo $applicant_id;?>" role="dialog">
                          <div class="modal-dialog modal-lg">
                            ...
                            <div class="modal-content">
                              <div align="center" class="modal-header">
                                <button type="button" class="close" data-dismiss="modal">&times;</button>
                                <h4 class="modal-title">Data Mengajukan Surat Keterangan Izin Penutupan Jalan</h4>
                              </div>
                              <div class="modal-body">
                                <!-- body -->
                                <?php
                                ...
                                $lihat=mysqli_query($conn,"select * from tb_population join tb_applicant on tb_population.population_nik=tb_applicant.population_nik join tb_road_clousure_permit_certificate on tb_applicant.applicant_id=tb_road_clousure_permit_certificate.applicant_id where tb_road_clousure_permit_certificate.rcpc_id='$rcpc_id'");

                                while ($out = mysqli_fetch_object($lihat)) {
                                  ?>
                                  <input type="hidden" name="rcpc_id" value="<?php echo $rcpc_id;?>">
                                  ...
                                  <div class="panel panel-default">
                                    <div class="panel-heading">
                                      <h4>Permohonan Surat Penutupan Jalan</h4>
                                    </div>
                                    <div class="panel-body">
                                      <div class="table-responsive">
                                        <table class="table">
                                          <tr>
                                            ...
                                            <td>:</td>
                                            <td width="525px" id="text3"><?php echo "$out->rcpc_activity"?></td>
                                            <td width="25px">
                                          ...
                                          <tr>
                                            <td  width="175px">Jenis Kegiatan</td>
                                            <td>:</td>
                                            <td width="525px" id="text4"><?php echo "$out->rcpc_character"?></td>
                                            <td width="25px">
                                          ...
                                          <tr>
                                            ...
                                            <td>:</td>
                                            <td width="525px" id="text4"><?php echo "$out->rcpc_time_start"?></td>
                                            <td width="25px">
                                              <button id="button4" type="button" class="btn btn-warning" onclick="copy('#text4')" href="#" data-toggle="popover4" data-content="Copied."><i class="fa fa-copy"></i></button>
                                            </td>
                                          </tr>
                                          ...
                                          <tr>
                                            ...
                                            <td>:</td>
                                            <td width="525px" id="text5"><?php echo "$out->rcpc_time_end"?></td>
                                            <td width="25px">
                                          ...
                                          <tr>
                                            ...
                                            <td>:</td>
                                            <td width="525px" id="text6"><?php echo "$out->rcpc_place"?></td>
                                            <td width="25px">
